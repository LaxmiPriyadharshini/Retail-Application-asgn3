...
var recordBlock = 1; //The number of records to write at once.
...
//Change the query to align with your schema
    if (numRecords == recordBlock) {
      ...
      query = `INSERT INTO productdata (productName, productgroup, productDescription, asin) VALUES ${values};`; //Template, replaces ${values} with the value of values.
      values = "";
      numRecords = 0;
      execute = true;
      //console.log(query);
